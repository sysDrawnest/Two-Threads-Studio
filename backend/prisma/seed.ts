...
async function main() {
  ...
  const categories = await Promise.all([
    ...
    prisma.category.upsert({ where: { slug: 'handkerchiefs' }, create: { id: 'cat5', name: 'Handkerchiefs', slug: 'handkerchiefs', image: 'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?q=80&w=800&auto=format&fit=crop', isActive: true, sortOrder: 5 }, update: {} }),
  ...
  const productSeeds: ProductSeed[] = [
    ...
    },
    {
      ...
      description: 'Three half-yard cuts of our signature unbleached linen. Sourced from an organic heritage mill in India, our linen offers the perfect tension and weave for precision embroidery.',
      ...
      origin: 'Sourced and packaged in India',
