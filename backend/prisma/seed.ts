...
async function main() {
  ...
  const categories = await Promise.all([
    prisma.category.upsert({ where: { slug: 'mens-clothing' }, create: { id: 'cat-mens', name: "Men's Clothing", slug: 'mens-clothing', image: 'https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?q=80&w=800&auto=format&fit=crop', isActive: true, sortOrder: 1 }, update: {} }),
    prisma.category.upsert({ where: { slug: 'womens-clothing' }, create: { id: 'cat-womens', name: "Women's Clothing", slug: 'womens-clothing', image: 'https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?q=80&w=800&auto=format&fit=crop', isActive: true, sortOrder: 2 }, update: {} }),
    prisma.category.upsert({ where: { slug: 'embroidery-kits' }, create: { id: 'cat1', name: 'Embroidery Kits', slug: 'embroidery-kits', image: 'https://images.unsplash.com/photo-1584446927514-633215c0e0b3?q=80&w=800&auto=format&fit=crop', isActive: true, sortOrder: 3 }, update: {} }),
    prisma.category.upsert({ where: { slug: 'crochet' }, create: { id: 'cat2', name: 'Crochet', slug: 'crochet', image: 'https://images.unsplash.com/photo-1617896848219-aab8a02eed8c?q=80&w=800&auto=format&fit=crop', isActive: true, sortOrder: 4 }, update: {} }),
    prisma.category.upsert({ where: { slug: 'lippan-art' }, create: { id: 'cat3', name: 'Lippan Art', slug: 'lippan-art', image: 'https://images.unsplash.com/photo-1563453392212-326f5e854473?q=80&w=800&auto=format&fit=crop', isActive: true, sortOrder: 5 }, update: {} }),
    prisma.category.upsert({ where: { slug: 'macrame' }, create: { id: 'cat4', name: 'Macramé', slug: 'macrame', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=800&auto=format&fit=crop', isActive: true, sortOrder: 6 }, update: {} }),
    prisma.category.upsert({ where: { slug: 'handkerchiefs' }, create: { id: 'cat5', name: 'Handkerchiefs', slug: 'handkerchiefs', image: 'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?q=80&w=800&auto=format&fit=crop', isActive: true, sortOrder: 7 }, update: {} }),
    prisma.category.upsert({ where: { slug: 'home-decor' }, create: { id: 'cat7', name: 'Home Decor', slug: 'home-decor', image: 'https://images.unsplash.com/photo-1600335895229-6f755ef92cbf?q=80&w=800&auto=format&fit=crop', isActive: true, sortOrder: 8 }, update: {} }),
  ]);
  ...
  const productSeeds: ProductSeed[] = [
    {
      ...
      isFeatured: true, isHandmade: true, isSustainable: true, estimatedTime: '4 - 6 hours',
    ...
    },
    {
      ...
      isFeatured: false, isHandmade: false, isSustainable: true, estimatedTime: '3 - 5 hours',
    ...
    },
    {
      ...
      isFeatured: true, isHandmade: true, isSustainable: true, estimatedTime: '20 - 30 hours',
    ...
    },
    {
      ...
      isFeatured: false, isHandmade: false, isSustainable: true, estimatedTime: 'N/A',
    ...
    },
    {
      ...
      isFeatured: false, isHandmade: true, isSustainable: false, estimatedTime: '8 - 10 hours',
    ...
    },
    {
      ...
      stockQuantity: 999, status: ProductStatus.ACTIVE, type: ProductType.DIGITAL,
      difficulty: DifficultyLevel.BEGINNER,
      isFeatured: false, isHandmade: false, isSustainable: true, estimatedTime: '2 - 3 hours',
    ...
    },
    {
      ...
      badge: BadgeType.LIMITED, difficulty: DifficultyLevel.ADVANCED,
      isFeatured: true, isHandmade: true, isSustainable: true, isPersonalizable: true, estimatedTime: '40 hours',
    ...
    },
    {
      ...
      isFeatured: true, isHandmade: true, isSustainable: true, isPersonalizable: true, estimatedTime: '55 hours',
    ...
    },
    {
      ...
      badge: BadgeType.BEST_SELLER, difficulty: DifficultyLevel.BEGINNER,
      isFeatured: true, isHandmade: true, isSustainable: true, estimatedTime: 'Ready to hang',
    ...
    },
    {
      ...
      isFeatured: false, isHandmade: true, isSustainable: false, isPersonalizable: true,
    ...
    },
    {
      ...
      badge: BadgeType.BEST_SELLER, difficulty: DifficultyLevel.BEGINNER,
      isFeatured: false, isHandmade: true, isSustainable: true, estimatedTime: 'Ready to gift',
    ...
    },
    {
      ...
      isFeatured: true, isHandmade: true, isSustainable: true, isPersonalizable: true,
