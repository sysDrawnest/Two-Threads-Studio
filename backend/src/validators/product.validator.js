...
const productBaseSchema = z.object({
    ...
    difficulty: z.preprocess((val) => (typeof val === 'string' && val.trim() ? val.trim().toUpperCase() : val), z.nativeEnum(DifficultyLevel).optional()),
    // Classification
    studioType: z.preprocess((val) => (typeof val === 'string' && val.trim() ? val.trim().toUpperCase() : val), z.nativeEnum(StudioProductType).optional()),
