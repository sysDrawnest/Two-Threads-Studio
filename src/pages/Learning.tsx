...
const Learning: React.FC = () => {
  return (
    <PageContainer>
      <div className="flex-1 flex flex-col items-center justify-center py-32 px-6 bg-[#ede6de]">
        ...
        <p className="font-sans text-sm text-[#5a4a3f] max-w-lg text-center leading-loose">
          We are filming new tutorials to guide you through your stitching journey. Stay tuned.
        </p>
      </div>
    </PageContainer>
  );
