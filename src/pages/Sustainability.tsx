    ...
    <PageContainer>
      ...
      <section className="py-24 px-6 md:px-16 bg-background -mt-16 mx-4 md:mx-16 relative z-10 shadow-xl">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-16">
            ...
            <div className="order-1 md:order-2 aspect-[4/3] bg-surface-container overflow-hidden">
      ...
      <section className="py-24 px-6 md:px-16 bg-inverse-on-surface">
        <div className="max-w-5xl mx-auto">
          <h2 className="font-serif text-3xl md:text-5xl font-light text-center text-primary-container mb-16">
      ...
      <section className="py-16 px-6 bg-[#ede6de] text-center">
        <Link to="/about" className="font-sans text-sm uppercase tracking-[0.15em] text-primary-container hover:text-on-secondary-container transition-colors no-underline">
          ← Back to About Us
        </Link>
      </section>
    </PageContainer>
