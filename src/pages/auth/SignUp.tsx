    ...
    <div className="min-h-screen flex flex-col bg-[#F6F4F0] font-sans relative overflow-hidden text-[#111]">
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-6 pt-32 pb-24 w-full max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-16 lg:gap-24 w-full relative">
          ...
          <div className="hidden lg:flex flex-col p-8 w-[300px] relative bg-[#f9f8f4] shadow-[2px_4px_15px_rgba(0,0,0,0.05)] transform -rotate-1 border-r-4 border-[#eae5dc] mt-4 z-20">
            <div className="absolute -right-1 top-0 bottom-0 w-2 bg-gradient-to-l from-transparent to-[#f9f8f4] -z-10 mix-blend-overlay"></div>
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-[340px] flex flex-col relative z-30">
            ...
            <div className="hidden lg:block absolute -top-24 -right-12 w-32 h-32 flex-shrink-0 z-0">
          ...
          <div className="lg:hidden flex flex-col p-6 w-full max-w-[340px] relative bg-[#f9f8f4] shadow-sm transform -rotate-1 border-r-4 border-[#eae5dc] mt-8">
