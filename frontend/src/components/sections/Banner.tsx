      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16">
        <ScrollReveal direction="right" className="max-w-md bg-[#FAF9F7]/95 backdrop-blur-md p-8 md:p-12 shadow-xl border border-neutral-200/40 rounded-sm">
          ...
          <h2 className="font-serif text-2xl md:text-4xl font-light text-[#1C1C1B] leading-tight mb-4">
            Artisan Guild Collection
          </h2>
          <p className="font-sans text-xs md:text-sm text-neutral-500 leading-relaxed mb-8">
            Premium embroidery patterns and handcrafted pieces, curated for the modern artisan. 
            Bring the organic warmth of hand-loomed fibers into your home and creative practice.
          </p>
          <button className="bg-[#1C1C1B] text-[#FAF9F7] border border-[#1C1C1B] px-8 py-3.5 font-sans text-xs tracking-widest uppercase cursor-pointer hover:bg-[#A34A38] hover:border-[#A34A38] transition-colors duration-300 shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#1C1C1B]">
            Explore Collection
          </button>
        </ScrollReveal>
      </div>
