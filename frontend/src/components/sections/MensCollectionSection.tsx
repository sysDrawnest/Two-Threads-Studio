...
const products = [
  {
    ...
    name: 'Premium Embroidered Shirts',
    craft: 'Hand-threaded · Studio Artisan',
    image:
      'https://images.unsplash.com/photo-1617196034183-421b4040ed20?q=80&w=1200&auto=format&fit=crop',
    gridRole: 'featured',
  },
  {
    id: 'denim-jackets',
    name: 'Designer Denim Jackets',
    craft: 'Woven Craft · Indigo Heritage',
    image:
  ...
  {
    id: 'artisan-jeans',
    name: 'Artisan Denim Jeans',
    craft: 'Raw Denim · Studio Cut',
    image:
  ...
  },
  {
    ...
    craft: 'Stitch Detail · Accessory Heritage',
    image:
...
export default function MensCollectionSection() {
  ...
  return (
    <section
      id="mens-collection"
      className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-16 bg-[#F5EFE7]"
    >
        ...
        <div className="hidden lg:grid lg:grid-cols-12 lg:gap-12 lg:items-stretch">
          ...
          >
            ...
            <p className="font-sans text-[13px] text-[#5a4a3f] leading-[1.75] mb-8">
              Designed for the man who moves between cultures, boardrooms, and creative spaces.
              Each piece is hand-embroidered by our studio artisans, bridging traditional textile
              techniques with a clean, modern silhouette built for the global wardrobe.
            </p>
          ...
          <div className="lg:col-span-7 grid grid-cols-2 grid-rows-2 gap-4 h-[640px]">
            ...
            <ScrollReveal direction="up" className="row-span-2 overflow-hidden group">
              <div className="relative h-full bg-[#dfd8ce] overflow-hidden">
                <img
                  src={featured.image}
                  alt={featured.name}
                  loading="lazy"
        ...
        <div className="lg:hidden">
          <ScrollReveal direction="up" className="mb-8">
            <p className="font-sans text-[10px] tracking-[0.32em] uppercase text-[#A34A38] font-semibold mb-2">
              Men's Collection · Collection No. 01
            </p>
            <h2 className="font-serif text-3xl sm:text-4xl font-light text-[#1C1C1B] leading-tight mb-2">
              Premium Menswear <span className="text-amber-600 text-xl font-sans inline-block">★★★★★</span>
            </h2>
            <div className="h-px bg-[#1C1C1B]/12 mb-4" />
            <p className="font-sans text-sm text-[#5a4a3f] leading-relaxed">
              Handcrafted menswear bridging artisan tradition and modern fashion — designed
              for the man who values craft over convention.
            </p>
          </ScrollReveal>

          {/* Featured hero image */}
          <ScrollReveal direction="up" className="mb-4">
            <div className="relative aspect-[3/4] overflow-hidden group bg-[#dfd8ce]">
              <img
                src={featured.image}
                alt={featured.name}
                loading="lazy"
          ...
          <div className="grid grid-cols-2 gap-3 mb-8">
            {products.slice(1).map((item, i) => (
              <ScrollReveal key={item.id} direction="up" delay={0.07 * i}>
                <div className="relative aspect-square overflow-hidden group bg-[#dfd8ce]">
                  <img
                    src={item.image}
                    alt={item.name}
                    loading="lazy"
