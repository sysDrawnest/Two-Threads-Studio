...
export default function ShopByCategory() {
  ...
  return (
    <section className="relative bg-[#ede6de] pt-2 pb-6 md:pb-16 px-4 sm:px-6 md:px-16">
      ...
      <div className="relative z-20 max-w-7xl mx-auto bg-[#FBFBFA] rounded-[24px] md:rounded-[36px] shadow-[0_-15px_30px_-5px_rgba(0,0,0,0.15),_0_20px_40px_-15px_rgba(0,0,0,0.1)] -mt-10 sm:-mt-16 md:-mt-24 py-6 sm:py-12 md:py-20 px-4 sm:px-8 md:px-12">
        {/* Heading */}
