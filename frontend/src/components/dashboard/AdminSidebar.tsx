...
const navItems: NavItem[] = [
  ...
  { label: 'Promotions', path: '/admin/coupons', icon: <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M9 15l6-6M10 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm6 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM4 21h16a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2z"/></svg> },
