            ...
            <div className="lg:col-span-5 flex flex-col justify-center p-6 lg:p-8 bg-white border border-[#E8E4DF] rounded-sm shadow-sm">
              ...
              <div className="flex items-center justify-between pt-6 border-t border-neutral-100">
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-sm font-sans text-[10px] tracking-[0.2em] uppercase font-semibold flex items-center gap-2 transition-all ${addedProductId === config.heroPiece.id
                  ...
                  <div className="p-5 flex flex-col justify-between flex-1">
                    ...
                    <div className="pt-4 border-t border-neutral-100 flex items-center justify-between mt-3">
                      ...
                      <button
                        ...
                        className={`px-3.5 py-2 rounded-sm font-sans text-[10px] tracking-[0.15em] uppercase font-semibold flex items-center gap-1.5 transition-all ${addedProductId === product.id
                            ? 'bg-emerald-700 text-white'
                            : 'bg-[#1C1C1B] text-white hover:bg-[#A34A38]'
                          }`}
                      >
