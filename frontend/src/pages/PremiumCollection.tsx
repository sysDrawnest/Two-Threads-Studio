...
export default function PremiumCollection() {
  ...
  return (
    <PageContainer disablePadding={true}>
      ...
      {/* ─────────────────────────────────────────────────────────────────────────────
          04 — COLLECTION DISCOVERY (Pure Typographic Fashion House Invitation)
         ───────────────────────────────────────────────────────────────────────────── */}
      <section className="pt-20 pb-32 md:pt-28 md:pb-44 px-6 md:px-14 bg-[#FAF9F7] border-t border-[#E8E4DF] text-center">
        <div className="max-w-2xl mx-auto">
          <ScrollReveal direction="up">
            <span className="font-sans text-[10px] tracking-[0.35em] uppercase text-[#A34A38] font-bold block mb-3">
              EXPLORE THE OTHER COLLECTION
            </span>
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-light text-[#1C1C1B] tracking-tight mb-4">
              {otherConfig.tag}
            </h2>
            <p className="font-serif text-base sm:text-lg text-neutral-600 font-normal leading-relaxed mb-8 max-w-lg mx-auto">
              {otherConfig.statementHeadline} {otherConfig.heroSubtitle}
            </p>
            <Link
              to={`/collection/${otherCollectionKey}`}
              className="inline-flex items-center gap-2.5 font-sans text-xs tracking-[0.22em] uppercase font-semibold text-[#1C1C1B] border-b border-[#1C1C1B] pb-1 hover:text-[#A34A38] hover:border-[#A34A38] transition-colors"
            >
